...
os.environ['TF_CONFIG'] = json.dumps({
    'cluster': {
        'worker': ['IP1:20000', 'IP2:20001']#workers are 2 servers with GPU.
    },
    'task': {'type': 'worker', 'index': 1}#1 because it is a worker.
})
...
mainDirect_ = '/home/edgar/Edgar/Semestre 4/legw-multi-worker-fewExamples/'
...
numClasses_ = 10
shape = (28, 28)
pathTrain = '/home/edgar/tensorflow_datasets/quickdraw_bitmap/edgar/train/'
pathTest = '/home/edgar/tensorflow_datasets/quickdraw_bitmap/edgar/test/'
...
train, test = massMethods.supervisedPreProcessing(train,test,shape)#RGB (32,32,3) to (96,32)
